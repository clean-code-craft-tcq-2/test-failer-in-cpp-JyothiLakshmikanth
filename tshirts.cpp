...
//1. Analyse following code and explain which Principles of Clean Code were
// harmed or ignored
//  Give short explanations for your observations and pinpoint affected code parts
// #include<ctime>
// #include<iostream>
// using namespace std;
// #define BEGINNER 0
...
// playMinesweeperUtil(myBoard, realBoard, mines, row - 1,
// col, movesLeft);
// }
// //----------- 2nd Neighbour (South) ------------
// // Only process this cell if this is a valid one
...
// playMinesweeperUtil(myBoard, realBoard, mines, row, col
// + 1, movesLeft);
// }
// //----------- 4th Neighbour (West) ------------
// // Only process this cell if this is a valid one
...
// }
// }
// // A Function to place the mines randomlrandomly
// // on the board
...
// return;
// }
// // A Function to cheat by revealing where the minesare
// // placed.
...
// }
// currentMoveIndex++;
// gameOver = playMinesweeperUtil(myBoard, realBoard, mines, x, y,
// &movesLeft);
...
// return (0);
// }
// 2. Plan a refactoring of code from Q1
// Explain in detail which overall improvements in the analysed code you would make and
// support them with reason.
